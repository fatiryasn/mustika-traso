...
export default function ProdukLoading() {
  return (
    <div className="bg-background min-h-screen pb-16 pt-4 animate-pulse">
      {/* Banner skeleton – matches bold dark banner */}
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div className="h-3 bg-cyan-400/30 w-24 rounded" />
              </div>
      ...
      {/* Product grid skeleton – identical to before */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-wrap justify-center gap-6">
          {Array.from({ length: 6 }).map((_, i) => (
            <div
              key={i}
              className="w-full sm:w-[calc(50%-0.75rem)] lg:w-[calc(33.333%-1rem)] bg-white border animate-pulse"
            >
